...
const Hero = () => {
  return (
    <>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[700px] relative">
        {/* brand info */}
        <div className="flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0">
          <div className="text-center md:text-left space-y-6">
            ...
            >
              100% Jaminan Kepuasan Pelanggan
            </motion.p>
            <motion.h1
              variants={SlideRight(0.6)}
              initial="hidden"
              animate="visible"
              className="text-4xl font-semibold lg:text-4xl !leading-tight"
            >
              Membawa Solusi Pembayaran Digital Lebih Dekat dengan Anda
            </motion.h1>
            <motion.p
            ...
            >
              <button className="primary-btn bg-[#F7941C]">Gabung</button>
