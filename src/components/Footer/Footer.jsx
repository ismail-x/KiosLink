          ...
          <div className="grid md:grid-cols-4 md:gap-4 py-5 border-t-2 border-gray-300/10 text-black">
            ...
            <div className="py-8 px-4 space-y-4">
              <div className="text-2xl flex items-center gap-2 font-bold uppercase">
                ...
                <p className="">KIOS<span className="font-bold text-primary">LINK</span></p>
              </div>
              <p>
              Kantor KIOSLINK
              <br />
              Jl. Cemara 1 blok A1 No. 3, Selamat, Danau Sipin.
              Kota Jambi, 36129
              <br />
              Email: info@kioslink.com
              <br />
              Telepon: +62812 7509 0990
              </p>
